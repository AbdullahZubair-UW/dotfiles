...
keys = [
    ...
    Key([mod, "shift"], "d", lazy.spawn("rofi -show window"), desc="Run Rofi on windows"),
    Key([mod], "f", 
        lazy.spawn("rofi -modi file-browser-extended -show file-browser-extended"),
        desc="Run Rofi on windows"),
    ...
    Key([alt], "k", lazy.layout.move_up()),
    Key([alt], "j", lazy.layout.move_down()),
]
...
layouts = [
    ...
    layout.TreeTab(
     fontsize = 10,
     sections = ["Assignment", "Books", "Code", "Fourth"],
     section_fontsize = 10,
     border_width = 2,
     padding_left = 0,
     padding_x = 0,
